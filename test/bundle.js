...
/***/ function(module, exports, __webpack_require__) {
	...
	function convertToFullPathString(path, query, fragment) {
	    // to="{path:'/posts/10', query:{q:'mysearch'},hash:'#section1'}"
	    var result = path;
	    // query
	        ...
	        */
	        if (url.indexOf(baseHref) !== -1) {
	            ...
	            if (result === '') {
	                ...
	                return util_1.trimQueryAndFragment(result);
	            }
	        }
	        else {
	            return util_1.trimQueryAndFragment(url);
	        }
	    };
	...
	var HistoryMode = (function () {
	    function HistoryMode() {
	        ...
	        */
	        ...
	        this.baseHref = util_1.getBase();
	        this.current = new Route_1.Route({ path: '/', url: this.baseHref });
	    }
	...
	*/
	describe('Hash history', function () {
	    ...
	    it('Should get path from path', function () {
	        var baseHref = 'http://mysite.com/';
	        var result = hashHistory.getPath(baseHref, '/posts/10');
	        chai_1.assert.equal(result, '/posts/10');
	    });
	    it('Should get path from url', function () {
	        var baseHref = 'http://mysite.com/';
	        var result = hashHistory.getPath(baseHref, 'http://mysite.com/#/posts/10');
	        chai_1.assert.equal(result, '/posts/10');
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	describe('Html5 history', function () {
	    ...
	    it('Should get path from path', function () {
	        var baseHref = 'http://mysite.com/';
	        var result = html5History.getPath(baseHref, '/posts/10');
	        chai_1.assert.equal(result, '/posts/10');
	    });
	    it('Should get path from url', function () {
	        var baseHref = 'http://mysite.com/';
	        var result = html5History.getPath(baseHref, 'http://mysite.com/posts/10');
	        chai_1.assert.equal(result, '/posts/10');
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dom_1 = __webpack_require__(45);
	describe('Utils', function () {
	    ...
	    describe('Scroll', function () {
	        ...
	        it('Should scroll to fragment', function () {
	            dom_1.scrollToElement('#section1');
	            setTimeout(function () {
	                var elRect = anchor.getBoundingClientRect();
	                chai_1.assert.isTrue(elRect.top > 5000);
	            }, 500);
	        });
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Link = (function (_super) {
	    ...
	    function Link(props) {
	        ...
	        _this._fullLinkPathString = Router_1.routerHistory && Router_1.routerHistory instanceof HashHistory_1.HashHistory ? '#' + fullLinkPathString : fullLinkPathString;
